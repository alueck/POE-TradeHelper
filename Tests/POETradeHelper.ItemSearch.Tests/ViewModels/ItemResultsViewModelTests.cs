...
public class ItemResultsViewModelTests
{
    ...
    {
        SearchQueryRequest originalQueryRequest = new SearchQueryRequest { League = "test" };
    ...
    {
        SearchQueryRequest expected = new SearchQueryRequest { League = "abc" };
        this.searchQueryRequestFactoryMock
    ...
    public async Task ExecuteAdvancedQueryCommandCallsLoadAsyncOnAdvancedFiltersViewModel()
    {
        ...
        SearchQueryRequest queryRequest = new SearchQueryRequest { League = "abc" };
        this.searchQueryRequestFactoryMock
