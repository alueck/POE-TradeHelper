...
namespace POETradeHelper.ItemSearch.Tests.Services.Parsers
{
    public class PseudoItemStatsParserTests
    {
        ...
        public void ParseShouldCallGetPseudoStatDataOnPseudoStatDataMappingService()
        {
            ...
            this.pseudoStatsDataMappingServiceMock.Verify(x => x.GetPseudoStatDatas(itemStats[0].Id));
            this.pseudoStatsDataMappingServiceMock.Verify(x => x.GetPseudoStatDatas(itemStats[1].Id));
        }
        ...
        public void ParseShouldReturnPseudoItemStatIfTheSamePseudoStatDataIsReturnedTwoOrMoreTimes(int count)
        {
            ...
            this.pseudoStatsDataMappingServiceMock.Setup(x => x.GetPseudoStatDatas(It.IsAny<string>()))
        ...
        public void ParseShouldReturnSingleValueItemStatWithValueCombinedFromMatchingItemStats(int value1, int value2, int expected)
        {
            ...
            var pseudoStatData = new StatData { Id = "test stat data" };
            this.pseudoStatsDataMappingServiceMock.Setup(x => x.GetPseudoStatDatas(It.Is<string>(s => !string.IsNullOrEmpty(s))))
                .Returns(new[] { pseudoStatData });
        ...
        private void SetupPseudoStatsDataMappingServiceMockForDoubleResistanceStats()
        {
            ...
            this.pseudoStatsDataMappingServiceMock.Setup(x => x.GetPseudoStatDatas(It.Is<string>(s => s == StatId.FireAndColdResistance)))
            ...
            this.pseudoStatsDataMappingServiceMock.Setup(x => x.GetPseudoStatDatas(It.Is<string>(s => s == StatId.FireAndLightningResistance)))
            ...
            this.pseudoStatsDataMappingServiceMock.Setup(x => x.GetPseudoStatDatas(It.Is<string>(s => s == StatId.ColdAndLightningResistance)))
            ...
            this.pseudoStatsDataMappingServiceMock.Setup(x => x.GetPseudoStatDatas(It.Is<string>(s => s == StatId.FireResistance)))
                .Returns(new[] { totalFireResistanceStatData, totalElementalResistanceStatData, totalResistanceStatData });
            this.pseudoStatsDataMappingServiceMock.Setup(x => x.GetPseudoStatDatas(It.Is<string>(s => s == StatId.LightningResistance)))
                .Returns(new[] { totalLightningResistanceStatData, totalElementalResistanceStatData, totalResistanceStatData });
            this.pseudoStatsDataMappingServiceMock.Setup(x => x.GetPseudoStatDatas(It.Is<string>(s => s == StatId.ColdResistance)))
