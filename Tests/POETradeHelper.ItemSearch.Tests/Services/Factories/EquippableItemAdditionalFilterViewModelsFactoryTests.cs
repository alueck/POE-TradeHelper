...
namespace POETradeHelper.ItemSearch.Tests.Services.Factories
{
    public class EquippableItemAdditionalFilterViewModelsFactoryTests : AdditionalFilterViewModelsFactoryTestsBase
    {
        ...
        private static IEnumerable InfluenceFilterViewModelTestData
        {
            get
            {
                yield return new TestCaseData((Expression<Func<SearchQueryRequest, IFilter>>)((SearchQueryRequest x) => x.Query.Filters.MiscFilters.CrusaderItem), InfluenceType.Crusader);
                yield return new TestCaseData((Expression<Func<SearchQueryRequest, IFilter>>)((SearchQueryRequest x) => x.Query.Filters.MiscFilters.ElderItem), InfluenceType.Elder);
                yield return new TestCaseData((Expression<Func<SearchQueryRequest, IFilter>>)((SearchQueryRequest x) => x.Query.Filters.MiscFilters.HunterItem), InfluenceType.Hunter);
                yield return new TestCaseData((Expression<Func<SearchQueryRequest, IFilter>>)((SearchQueryRequest x) => x.Query.Filters.MiscFilters.RedeemerItem), InfluenceType.Redeemer);
                yield return new TestCaseData((Expression<Func<SearchQueryRequest, IFilter>>)((SearchQueryRequest x) => x.Query.Filters.MiscFilters.ShaperItem), InfluenceType.Shaper);
                yield return new TestCaseData((Expression<Func<SearchQueryRequest, IFilter>>)((SearchQueryRequest x) => x.Query.Filters.MiscFilters.WarlordItem), InfluenceType.Warlord);
            }
        }
